export const Data: any = {
  ...
  Courses: [
    {
      course: 'Angular NgRx: Getting Started',
      details: 'Pluralsight - Deborah Kurata, and Duncan Hunter (April 2024)',
    },
    {
      course: 'Node.js, Express, MongoDB & More: The Complete Bootcamp',
      details: 'Udemy - Jonas Schmedtmann (Feb 2024)',
    },
    {
      course: 'Testing JavaScript with Cypress – Full Course',
      details: 'FreeCodeCamp.org - Ryan Solomon (Oct 2023)',
    },
    {
      course: 'Angular Testing Masterclass (Angular 16)',
      details: 'Udemy- Angular University (Oct 2023)',
    },
    {
    ...
    },
    {
      ...
      details: 'edx.org (Dec 2021)',
    },
    {
      course: 'Getting Started as a Freelancer (Upwork) ',
      details: 'Mahara-Tech (Sep 2021)',
    },
    {
      course: 'Decor & Interior Design Course ',
      details: 'Benaa academy - Eng. Reham Mohsen (Aug 2019)',
    },
  ],
  Education: [
    {
      ...
      details: [
        'Intensive Code Camp Aug 2021 - Dec 2021',
  ...
  InterpersonalSkills:
    'Fast learner, highly adaptable, curious, motivated, and Committed to completing assignments before deadlines.',
  ...
  '': { Name: 'Hani Mohsen', Title: 'front-end developer' },
  Objective:
  ...
  Personal:
    'Front-end developer with 3 years of experience in web development using Angular and React.js. Strong knowledge of building responsive, user-friendly web applications considering best practices and clean code. Always Keeping myself up to date with the latest technologies and industry trends.',
  PersonalInfo: [
    'Address 1: Mansoura City, Dakahlia',
    'Address 2: Maadi, Cairo',
    'Military Status: Exempted',
  ],
  Projects: [
    {
      description: 'استيراد سيارات المصريين بالخارج',
      name: ' Cars Import initiative for Egyptians abroad',
    },
    {
      description: 'مؤتمر المناخ العالمي بشرم الشيخ',
      name: 'COP 27',
    },
    {
      description: 'Front-end Micro Service',
    ...
    {
      description:
        'A system that collects and visualize data obtained from meteorological devices',
      name: 'Data Logger System',
    },
    {
      code: 'https://github.com/hanimohsen31/Screen-Record',
      deployment: 'https://screen-recorder-500.web.app/',
      name: 'Screen Recording App',
    },
    {
      code: 'https://github.com/hanimohsen31/Angular-Ecommerce',
      deployment: 'https://angular-ecommerce-300.web.app/home',
      name: 'E-Commerce Web app with Angular',
    },
    {
      code: 'https://github.com/hanimohsen31/E-CommerceApp',
      deployment: 'https://react-ecommerce-500.web.app/',
      name: 'E-Commerce Web app with React',
    },
    {
      code: 'https://github.com/hanimohsen31/FoodCalculator',
      deployment: 'https://food-calculator-800.web.app/',
    ...
    {
      code: 'https://github.com/hanimohsen31/Personal-WebSite',
      deployment: 'https://collection-300.web.app/',
  ...
  TechnicalSkillsExplained: [
    'Proficient in HTML and CSS for creating responsive and visually appealing front-end interfaces.Experience with SCSS and Bootstrap for faster and more efficient styling and layout.Strong knowledge of JavaScript and TypeScript for creating interactive web applications.Good knowledge in React.js and Angular for building scalable and modular front-end components.Very good coding skills with a focus on clean, maintainable, and efficient code.Experience with integrating third-party APIs and services for added functionality and features.',
  ],
  WorkExperience: [
    {
      comp: 'GET Group Holdings Ltd.',
      desc: 'Front-end Developer using  Angular framework for building Projects such as Cars Import initiative for Egyptians abroad, COP 27 , Report Builder and Reusable Component (Front-end Microservices).',
    ...
    },
    {
      ...
      period: 'August 2021 - December 2021 | 3 Months',
      time: 'Internship',
    ...
    },
    {
      ...
      period: 'June 2021 - September 2022 | 1 years and 3 Months',
      time: 'Part Time',
    ...
    {
      comp: 'El-Asrya Company ',
      desc: 'Fiber networks and infrastructure projects.',
      period: 'September 2019 -June 2021 | 1 Year and 9 Months',
      time: 'Full Time',
